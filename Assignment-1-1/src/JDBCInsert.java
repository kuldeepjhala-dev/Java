...
public class JDBCInsert {
	...
	JDBCInsert(int id, String name, String author, String pub, String dop, int price, int quantity, int cost) {
		...
		try 
		{
			...
			st.executeUpdate("insert into bookstore values("+id+", '"+name+"', '"+author+"', '"+pub+"', '"+dop+"', "+price+", "+quantity+", "+cost+")");
		}
		catch(Exception e)
		{
